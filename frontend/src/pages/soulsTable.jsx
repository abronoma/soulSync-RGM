  ...
  const SoulRecordsList = () => {
    ...
    return (
      <div className="min-h-screen bg-black text-white p-6">
        <h1 className="text-2xl font-bold text-white mb-6">Soul Records</h1>
  ...
  const SoulDashboard = ({ soul }) => {
    return (
      <div className="min-h-screen bg-black text-white p-6 max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <div className="w-20 h-20 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 flex items-center justify-center">
              <span className="text-white font-bold text-xl">{soul.name.split(' ').map(n => n[0]).join('')}</span>
            </div>
          </div>
        ...
        <div className="mb-8">
          <h3 className="text-lg font-medium text-white mb-4">Upcoming Follow-Ups</h3>
        ...
        <div className="bg-gray-900 rounded-lg border border-gray-800 p-6 mb-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              <div className="text-white font-medium mb-2">Phone</div>
              <input 
                type="text" 
