      ...
      {currentView === "dashboard" && selectedSoul && (
        <div className="bg-[#1A1A2C] rounded-xl border border-[#2A2A3F] overflow-hidden">
          ...
          <div className="p-4 md:p-6 bg-gradient-to-r from-[#1A1A2C] to-[#2A2A3F] border-b border-[#2A2A3F]">
            <div className="max-w-5xl mx-auto">
              <button
                ...
                className="mb-4 text-[#9999B5] hover:text-white p-2 rounded-lg hover:bg-[#2A2A3F] transition-colors"
              >
          ...
          <div className="p-4 md:p-6">
            {/* center wrapper to limit width of cards */}
            <div className="max-w-5xl mx-auto">
              {/* Header aligned with forms */}
              <div className="flex items-center justify-between mb-6 md:mb-8">
                <div>
                  <h2 className="text-xl md:text-2xl font-bold text-white">
                    {selectedSoul.fullName || selectedSoul.name}'s Dashboard
                  </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 md:mb-8">
                <div className="bg-[#2A2A3F] p-5 rounded-lg border border-[#3A3A4F]">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-white flex items-center">
                        ...
                        {selectedSoul.phoneNumber || selectedSoul.contact || "-"}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
              ...
              {/* Notes */}
              <div className="bg-[#2A2A3F] p-5 rounded-lg border border-[#3A3A4F] mb-6 md:mb-8">
                <h3 className="text-lg font-semibold text-white mb-3">Notes</h3>
                <p className="text-[#CCCCEE]">{selectedSoul.notes ?? "No notes available."}</p>
              </div>
              ...
              <div className="bg-[#2A2A3F] p-5 rounded-lg border border-[#3A3A4F]">
                ...
                {/* Display both forms always but conditionally shown */}
                <div className="space-y-4">
                  {/* Tech-inclined Form */}
                  <div className={`${followUpType !== "Tech-inclined" ? "hidden" : ""}`}>
                    <div className="bg-[#3A3A4F] p-4 rounded-lg border border-[#4A4A5F]">
                  ...
                  <div className={`${followUpType !== "Non-tech inclined" ? "hidden" : ""}`}>
                    <div className="bg-[#3A3A4F] p-4 rounded-lg border border-[#4A4A5F]">
                      <h4 className="text-md font-semibold text-white mb-4 flex items-center">
                        <Book className="w-5 h-5 mr-2 text-[#D946EF]" />
                ...
                {followUpType && (
                  <div className="flex justify-center mt-4">
                    <button
                      ...
                      className="bg-gradient-to-r from-[#D946EF] to-[#9333EA] hover:from-[#c026d3] hover:to-[#7e22ce] text-white font-semibold py-2 px-6 rounded-lg flex items-center transition-all duration-300"
                    >
