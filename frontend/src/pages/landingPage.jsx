    ...
    <div className="min-h-screen text-white relative overflow-hidden">
      ...
      <div className={`fixed top-0 right-0 w-full h-full bg-black/95 backdrop-blur-lg z-40 transform transition-transform duration-300 ease-in-out ${mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'} md:hidden`}>
        <div className="flex flex-col p-6 sm:p-8 space-y-6 sm:space-y-8 mt-16 sm:mt-20">
          ...
          >
            <ArrowRight className="mr-3 w-4 h-4 sm:w-5 sm:h-5" /> Features
          </a>
          <a 
            href="#stats" 
            className="text-[#9999B5] hover:text-white transition-colors font-medium py-3 text-lg sm:text-xl flex items-center"
            onClick={() => setMobileMenuOpen(false)}
          >
            <ArrowRight className="mr-3 w-4 h-4 sm:w-5 sm:h-5" /> Impact
          </a>
          <a 
            href="#testimonials" 
            className="text-[#9999B5] hover:text-white transition-colors font-medium py-3 text-lg sm:text-xl flex items-center"
            onClick={() => setMobileMenuOpen(false)}
          >
            <ArrowRight className="mr-3 w-4 h-4 sm:w-5 sm:h-5" /> Testimonials
          </a>
          <a 
            href="#contact" 
            className="text-[#9999B5] hover:text-white transition-colors font-medium py-3 text-lg sm:text-xl flex items-center"
          ...
          <button
            ...
            className="bg-gradient-to-r from-[#D946EF] to-[#9333EA] px-5 py-3 sm:px-6 sm:py-4 rounded-lg text-base sm:text-lg font-semibold text-white flex items-center justify-center gap-2 mt-6 sm:mt-8"
          >
            Start Your Journey
     ...
     <section className="bg-gradient-to-r from-[#1A1A2C] to-[#0E0E17]  relative px-4 sm:px-6 pt-28 pb-16 sm:pt-32 sm:pb-20 text-center min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <p className="text-base sm:text-lg md:text-xl mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed text-[#CCCCEE] px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4">
            <button
              ...
              className="bg-gradient-to-r from-[#D946EF] to-[#9333EA] hover:from-[#c026d3] hover:to-[#7e22ce] px-6 py-3 sm:px-8 sm:py-4 rounded-lg text-base sm:text-lg font-semibold text-white flex items-center gap-2 group shadow-lg shadow-[#D946EF]/40 hover:shadow-[#D946EF]/60 transition-all duration-300 transform hover:-translate-y-1 w-full sm:w-auto justify-center"
            >
              Start Your Journey
              <ChevronRight className="w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="bg-white/10 hover:bg-white/20 backdrop-blur-sm px-6 py-3 sm:px-8 sm:py-4 rounded-lg text-base sm:text-lg font-semibold text-white border border-white/20 hover:border-white/40 transition-all duration-300 flex items-center gap-2 w-full sm:w-auto justify-center">
     ...
     <section id="stats" className="py-16 sm:py-20 px-4 sm:px-6 relative z-10 bg-gradient-to-b from-[#1f1f2e] to-[#070711] min-h-screen flex items-center">
        <div className="max-w-6xl mx-auto w-full">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-base sm:text-lg text-[#9999B5] max-w-2xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            {/* Feature 1 */}
            <div className="p-6 sm:p-8 rounded-2xl bg-gradient-to-b from-[#1A1A2C] to-[#0E0E17] border border-[#2A2A3F] shadow-2xl hover:shadow-[0_0_30px_#D946EF20] transition-all duration-500 group">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-r from-[#D946EF] to-[#9333EA] flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                <Heart className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
              </div>
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-white">Prayer Management</h3>
              <p className="text-[#9999B5] mb-4 sm:mb-6 text-sm sm:text-base">
                Organize prayer lists, set reminders, and track progress for every soul you're interceding for.
              </p>
              <ul className="space-y-2 text-[#CCCCEE] text-sm sm:text-base">
            ...
            {/* Feature 2 */}
            <div className="p-6 sm:p-8 rounded-2xl bg-gradient-to-b from-[#1A1A2C] to-[#0E0E17] border border-[#2A2A3F] shadow-2xl hover:shadow-[0_0_30px_#F59E0B20] transition-all duration-500 group">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-r from-[#F59E0B] to-[#D97706] flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                <Users className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
              </div>
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-white">Contact Intelligence</h3>
              <p className="text-[#9999B5] mb-4 sm:mb-6 text-sm sm:text-base">
            ...
            {/* Feature 3 */}
            <div className="p-6 sm:p-8 rounded-2xl bg-gradient-to-b from-[#1A1A2C] to-[#0E0E17] border border-[#2A2A3F] shadow-2xl hover:shadow-[0_0_30px_#EF444420] transition-all duration-500 group">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-r from-[#EF4444] to-[#DC2626] flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                <Target className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
              </div>
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-white">Victory Analytics</h3>
              <p className="text-[#9999B5] mb-4 sm:mb-6 text-sm sm:text-base">
...
<div 
  ...
  style={{ 
    backgroundImage: "url('rgm1.png')",
    backgroundSize: "70%", // Adjust this percentage to control the image size
    backgroundRepeat: "no-repeat",
...
></div>
        ...
        <div className="max-w-4xl mx-auto w-full text-center relative z-10">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-white">Ready to Transform Your Ministry?</h2>
          <p className="text-lg sm:text-xl text-[#9999B5] mb-8 sm:mb-10 max-w-2xl mx-auto px-4">
            Join thousands of soul winners already using SoulSync to make an eternal impact.
          </p>
          <button
            onClick={() => setAuthOpen(true)}
            className="bg-gradient-to-r from-[#D946EF] to-[#9333EA] hover:from-[#c026d3] hover:to-[#7e22ce] px-6 py-3 sm:px-8 sm:py-4 rounded-lg text-base sm:text-lg font-semibold text-white flex items-center gap-2 group mx-auto shadow-lg shadow-[#D946EF]/40 hover:shadow-[#D946EF]/60 transition-all duration-300 transform hover:-translate-y-1"
          >
      ...
      {/* Footer */}
      <footer id="contact" className="px-4 sm:px-6 py-12 relative border-t border-white/10 bg-[#0A0A12] min-h-[50vh] flex items-center">
        <div className="max-w-6xl mx-auto w-full">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8 mb-8">
            <div>
              ...
              <p className="text-[#9999B5] mb-4 text-sm sm:text-base">
                Transforming lives, one soul at a time through divinely inspired technology.
              </p>
              {/* Social Media Links */}
              <div className="flex space-x-3 sm:space-x-4">
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                  </svg>
                </a>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
